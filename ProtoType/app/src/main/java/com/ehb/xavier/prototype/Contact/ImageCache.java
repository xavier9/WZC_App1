...
public class ImageCache {
    ...
    /**
     * Find and return an existing ImageCache stored in a {@link com.ehb.xavier.contactlijst.util.ImageCache.RetainFragment}, if not found a new
     * one is created using the supplied params and saved to a {@link com.ehb.xavier.contactlijst.util.ImageCache.RetainFragment}.
     *
