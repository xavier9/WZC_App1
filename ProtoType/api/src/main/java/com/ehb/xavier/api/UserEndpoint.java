 ...
 */
@Api(name = "userEndpoint", version = "v1", namespace = @ApiNamespace(ownerDomain = "api.xavier.ehb.com", ownerName = "api.xavier.ehb.com", packagePath=""))
...
//Find the next cursor
    ...
    public User insertUser(User quote) throws ConflictException {
...
//when we use put
    ...
    public User updateUsre(User quote)throws NotFoundException {
        if (findRecord(quote.getId()) == null) {
