...
package com.ehb.xavier.api.userEndpoint;
...
public class UserEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.22.0 of the userEndpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class FindRol extends UserEndpointRequest<com.ehb.xavier.api.userEndpoint.model.User> {
    ...
    protected FindRol(java.lang.Long id) {
      super(UserEndpoint.this, "POST", REST_PATH, null, com.ehb.xavier.api.userEndpoint.model.User.class);
   ...
   *
   * @param content the {@link com.ehb.xavier.api.userEndpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.ehb.xavier.api.userEndpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserEndpointRequest<com.ehb.xavier.api.userEndpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.ehb.xavier.api.userEndpoint.model.User content) {
      super(UserEndpoint.this, "POST", REST_PATH, content, com.ehb.xavier.api.userEndpoint.model.User.class);
    }
  ...
  public class List extends UserEndpointRequest<com.ehb.xavier.api.userEndpoint.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserEndpoint.this, "GET", REST_PATH, null, com.ehb.xavier.api.userEndpoint.model.CollectionResponseUser.class);
    }
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.ehb.xavier.api.userEndpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserEndpointRequest<com.ehb.xavier.api.userEndpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.ehb.xavier.api.userEndpoint.model.User content) {
      super(UserEndpoint.this, "PUT", REST_PATH, content, com.ehb.xavier.api.userEndpoint.model.User.class);
    }
