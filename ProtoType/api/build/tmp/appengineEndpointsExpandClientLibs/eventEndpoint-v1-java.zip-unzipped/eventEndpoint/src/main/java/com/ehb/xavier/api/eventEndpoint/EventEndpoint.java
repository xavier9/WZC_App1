...
package com.ehb.xavier.api.eventEndpoint;
...
public class EventEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "findEvent".
   *
   * This request holds the parameters needed by the eventEndpoint server.  After setting any optional
   * parameters, call the {@link FindEvent#execute()} method to invoke the remote operation.
   *
   * @param id
   * @return the request
   */
  public FindEvent findEvent(java.lang.Long id) throws java.io.IOException {
    FindEvent result = new FindEvent(id);
    initialize(result);
    return result;
  }

  public class FindEvent extends EventEndpointRequest<com.ehb.xavier.api.eventEndpoint.model.Event> {
     ...
     * optional parameters, call the {@link FindEvent#execute()} method to invoke the remote
     * operation. <p> {@link
     * FindEvent#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param id
     * @since 1.13
     */
    protected FindEvent(java.lang.Long id) {
      super(EventEndpoint.this, "POST", REST_PATH, null, com.ehb.xavier.api.eventEndpoint.model.Event.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }

    @Override
    public FindEvent setAlt(java.lang.String alt) {
      return (FindEvent) super.setAlt(alt);
    }

    @Override
    public FindEvent setFields(java.lang.String fields) {
      return (FindEvent) super.setFields(fields);
    }

    @Override
    public FindEvent setKey(java.lang.String key) {
      return (FindEvent) super.setKey(key);
    }

    @Override
    public FindEvent setOauthToken(java.lang.String oauthToken) {
      return (FindEvent) super.setOauthToken(oauthToken);
    }

    @Override
    public FindEvent setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FindEvent) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FindEvent setQuotaUser(java.lang.String quotaUser) {
      return (FindEvent) super.setQuotaUser(quotaUser);
    }

    @Override
    public FindEvent setUserIp(java.lang.String userIp) {
      return (FindEvent) super.setUserIp(userIp);
    }
    ...
    public FindEvent setId(java.lang.Long id) {
      this.id = id;
      return this;
    }

    @Override
    public FindEvent set(String parameterName, Object value) {
      return (FindEvent) super.set(parameterName, value);
    }
  }
   ...
   *
   * @param content the {@link com.ehb.xavier.api.eventEndpoint.model.Event}
   * @return the request
   */
  public InsertEvent insertEvent(com.ehb.xavier.api.eventEndpoint.model.Event content) throws java.io.IOException {
    InsertEvent result = new InsertEvent(content);
    initialize(result);
    return result;
  }

  public class InsertEvent extends EventEndpointRequest<com.ehb.xavier.api.eventEndpoint.model.Event> {
     ...
     * @since 1.13
     */
    protected InsertEvent(com.ehb.xavier.api.eventEndpoint.model.Event content) {
      super(EventEndpoint.this, "POST", REST_PATH, content, com.ehb.xavier.api.eventEndpoint.model.Event.class);
    }
  ...
  public class List extends EventEndpointRequest<com.ehb.xavier.api.eventEndpoint.model.CollectionResponseEvent> {
     ...
     */
    protected List() {
      super(EventEndpoint.this, "GET", REST_PATH, null, com.ehb.xavier.api.eventEndpoint.model.CollectionResponseEvent.class);
    }
   ...
   * @return the request
   */
  public UpdateEvent updateEvent(com.ehb.xavier.api.eventEndpoint.model.Event content) throws java.io.IOException {
    UpdateEvent result = new UpdateEvent(content);
    initialize(result);
    return result;
  }

  public class UpdateEvent extends EventEndpointRequest<com.ehb.xavier.api.eventEndpoint.model.Event> {
     ...
     * @since 1.13
     */
    protected UpdateEvent(com.ehb.xavier.api.eventEndpoint.model.Event content) {
      super(EventEndpoint.this, "PUT", REST_PATH, content, com.ehb.xavier.api.eventEndpoint.model.Event.class);
    }
